...
class ViewController: UICollectionViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        if let savedPeople = defaults.object(forKey: "people") as? Data { //We pull out our "people" key from our saved data, typecasting it carefully as a Data.
            if let decodedPeople = try? NSKeyedUnarchiver.unarchiveTopLevelObjectWithData(savedPeople) as? [Person] { // We decode that and typecast the decoded value as 'Person' array (which is also 'people'.
                people = decodedPeople // We put that into the 'people' array.
            }
        }
    }
    ...
    func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [UIImagePickerController.InfoKey : Any]) {
        ...
        save() // Saves the data at the point when the image is chosen.
    ...
    override func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        ac.addAction(UIAlertAction(title: "Rename", style: .default) { [weak self, weak ac] _ in
            ...
            person.name = newName
            self?.save() // Saves the name of the person.
    ...
    } // This function will write our 'people' array ('withRootObject: people') to the '"people"' key, but first it will wrap that inside a data object, called 'savedData'.
}
