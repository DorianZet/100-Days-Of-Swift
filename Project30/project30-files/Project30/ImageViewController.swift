...
class ImageViewController: UIViewController {
	weak var owner: SelectionViewController! // adding 'weak' here breaks the strong reference cycle between the view controllers.
	var image: String!
	var animTimer: Timer!
    ...
    override func viewWillDisappear(_ animated: Bool) {
        ...
        animTimer.invalidate() // calling 'invalidate()' on a timer stops it immediately, which also forces it to release strong reference on a view controller it belongs to, thus breaking the strong reference cycle.
    }
