...
class ViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    func getNewestCommitDate() -> String {
        ...
        // HERE IS THE PROBLEM: most likely, I did something wrong with reading the 'newestDate' as an OBJECT, because doing it so makes the table view rows go crazy. So I think it should be tweaked here. Other than that, I think that saving the method was in a proper position (you can check it out in the backup copy, it's 'saveNewestDate()' method.
//        let defaults = UserDefaults.standard
//        let newestDate = defaults.object(forKey: "NewestDate") as? Date
//        let formatter = ISO8601DateFormatter()
//
//        if newestDate != nil {
//            let readNewestDate = formatter.string(from: newestDate!)
//            print("Newest date loaded: \(readNewestDate)")
//
//            return readNewestDate
//        }
//
